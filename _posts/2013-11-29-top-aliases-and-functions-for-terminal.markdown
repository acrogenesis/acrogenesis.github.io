...
To add this aliases and functions to your terminal simply run {% highlight bash %} vim ~/.bash_profile {% endhighlight %} if it doesn't exit it will create a new one.
